...
- No ordering when switching im really fast(not necessary to fix because human can't switch that fast). If you really need ordering, please report an issue or make a pull request.
